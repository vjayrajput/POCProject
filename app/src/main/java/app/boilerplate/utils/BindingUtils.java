...
import app.boilerplate.ui.detail.fragment.CategoryAdapter;
import app.boilerplate.ui.detail.fragment.CategoryItemViewModel;
import app.boilerplate.ui.restaurant.fragment.RestaurantAdapter;
...
public final class BindingUtils {
    ...
    public static void addCategoryItems(RecyclerView recyclerView, List<CategoryItemViewModel> restaurantItems) {
        CategoryAdapter adapter = (CategoryAdapter) recyclerView.getAdapter();
        if (adapter != null) {
            adapter.clearItems();
            adapter.addItems(restaurantItems);
        }
    }

    @BindingAdapter({"adapter"})
    public static void addRestaurantItems(RecyclerView recyclerView, List<RestaurantItemViewModel> restaurantItems) {
