...
public class RestaurantDetailActivityViewModel extends BaseViewModel {
    private MutableLiveData<Integer> currentPage;
    private MutableLiveData<Integer> tabSelected;

    public RestaurantDetailActivityViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
